...
/**
 * AWS Lambda function to retrieve the security answer for a user based on their email.
 *
 ...
 *
 * Returns:
 *   object: A response object with a status code and a body. The body contains either the security answer for the user,
...
exports.handler = async (event) => {
  ...
  try {
    ...
    return {
      statusCode: 200,
      body: JSON.stringify({ securityAnswer: data.Item.securityAnswer }),
    };
  } catch (error) {
    return {
      statusCode: 500,
